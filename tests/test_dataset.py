...
class TestDataset(unittest.TestCase):
    @patch("medicalexplainer.dataset.check_output")
    @patch("os.path.exists", return_value=True)
    @patch("os.path.isfile", return_value=True)
    @patch("medicalexplainer.dataset.rdpcap")
    ...
    @patch("medicalexplainer.dataset.check_output", return_value=b"Mocked Data")
    @patch("os.path.exists", return_value=True)
    @patch("os.path.isfile", return_value=True)
    @patch("medicalexplainer.dataset.rdpcap")
